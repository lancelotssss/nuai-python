// src/pages/faculty-admin/faculty/system-audit/FacultySystemAudit.jsx

import { useEffect, useMemo, useState } from "react";

import PageTitle from "@/components/PageTitle";
import ViewLogs from "@/pages/public/ViewLogs";
...
export default function FacultySystemAudit() {
  ...
  const actorRole = safe(account?.role) || "Faculty";
  ...
  return (
    <>
      <PageTitle title="System Audit | Internship Adviser | NUAI" />

      <ViewLogs
        title="My System Audit"
        description="Review your personal recorded system activity and recent actions across the Internship Adviser portal."
        rows={rows}
        loading={loading}
        error={err}
